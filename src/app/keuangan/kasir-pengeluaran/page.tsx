...
function KasirPengeluaranContent() {
  const { user } = useAuth();
  const router = useRouter();
  const [activeTab, setActiveTab] = useState<'penerimaan' | 'pengeluaran'>('pengeluaran');
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-800">Kasir Pengeluaran</h1>
          <p className="text-gray-500 mt-1">Kelola pengeluaran sekolah</p>
        </div>
...
export default function KasirPengeluaranPage() {
  return <KasirPengeluaranContent />;
}
